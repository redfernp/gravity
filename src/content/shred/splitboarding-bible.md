...
1. Find a flat or gently inclined spot. You need room to work and a surface that won't slide under you.
2. Remove the skins from each board half. Fold them skin-to-skin to preserve the adhesive. Put them somewhere accessible in your pack.
3. Join the two board halves. The nose clips engage first, then the tail clips. Check they're fully locked: a board that partially separates on a steep descent is dangerous.
4. Clip the interface brackets from touring position to riding position on both bindings.
5. Adjust binding angles if you ride a split-specific angle setup versus your touring angles.
6. Put your pack back on. Check your beacon is in transmit mode.
7. Go.
